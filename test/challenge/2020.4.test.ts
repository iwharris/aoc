...
describe(testName(solution), () => {
    ...
    describe('Part 2', () => {
        ...
        it('should allow valid passports', () => {
            ...
            expect(solution.solvePart2(valid)).toBe('4');
        });

        it('should deny invalid passports', () => {
            const invalid = parseInput(
                `
                eyr:1972 cid:100
            ...
            expect(solution.solvePart2(invalid)).toBe('0');
        });
    });
});
